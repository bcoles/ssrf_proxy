...
#
# @note SSRFProxy::HTTP integration tests with cURL SSRF
#
class TestIntegrationSSRFProxyHTTPCurlSsrf < Minitest::Test
  parallelize_me!

  #
  # @note test send_uri GET method
  #
  def test_send_uri_get_curl
    # http get
  ...
  #
  def test_send_uri_guess_mime_curl
  ...
  #
  def test_send_uri_guess_status_curl
    ssrf = SSRFProxy::HTTP.new(url: 'http://127.0.0.1:8088/curl?url=xxURLxx')
    assert valid_ssrf?(ssrf)
  ...
  #
  def test_send_uri_ask_password_curl
    ssrf = SSRFProxy::HTTP.new(url: 'http://127.0.0.1:8088/curl?url=xxURLxx')
    assert valid_ssrf?(ssrf)
  ...
  #
  def test_send_uri_detect_redirect_curl
    ssrf = SSRFProxy::HTTP.new(url: 'http://127.0.0.1:8088/curl?url=xxURLxx')
    assert valid_ssrf?(ssrf)
  ...
  #
  def test_send_request_get_curl
    opts = SSRF_DEFAULT_OPTS.dup
    opts[:url] = 'http://127.0.0.1:8088/curl?url=xxURLxx'
    ssrf = SSRFProxy::HTTP.new(opts)
    assert valid_ssrf?(ssrf)
  ...
  #
  def test_send_request_head_curl
    opts = SSRF_DEFAULT_OPTS.dup
    opts[:url] = 'http://127.0.0.1:8088/curl?url=xxURLxx'
    opts[:method] = 'HEAD'
    ssrf = SSRFProxy::HTTP.new(opts)
  ...
  #
  def test_send_request_post_curl
    opts = SSRF_DEFAULT_OPTS.dup
    opts[:url] = 'http://127.0.0.1:8088/curl'
    opts[:method] = 'POST'
    opts[:post_data] = 'url=xxURLxx'
  ...
  #
  def test_send_request_match_curl
    ssrf = SSRFProxy::HTTP.new(url: 'http://127.0.0.1:8088/curl?url=xxURLxx')
    assert valid_ssrf?(ssrf)
  ...
  # 
  def test_send_request_guess_mime_curl
    ssrf = SSRFProxy::HTTP.new(url: 'http://127.0.0.1:8088/curl?url=xxURLxx')
    assert valid_ssrf?(ssrf)
  ...
  # 
  def test_send_request_guess_status_curl
    ssrf = SSRFProxy::HTTP.new(url: 'http://127.0.0.1:8088/curl?url=xxURLxx')
    assert valid_ssrf?(ssrf)
  ...
  # 
  def test_send_request_add_authenticate_header_curl
    ssrf = SSRFProxy::HTTP.new(url: 'http://127.0.0.1:8088/curl?url=xxURLxx')
    assert valid_ssrf?(ssrf)
  ...
  # 
  def test_send_request_add_location_header_curl
    ssrf = SSRFProxy::HTTP.new(url: 'http://127.0.0.1:8088/curl?url=xxURLxx')
    assert valid_ssrf?(ssrf)
  ...
  # 
  def test_send_request_body_to_uri_curl
    ssrf = SSRFProxy::HTTP.new(url: 'http://127.0.0.1:8088/curl?url=xxURLxx')
    assert valid_ssrf?(ssrf)
  ...
  # 
  def test_send_request_cookies_to_uri_curl
    ssrf = SSRFProxy::HTTP.new(url: 'http://127.0.0.1:8088/curl?url=xxURLxx')
    assert valid_ssrf?(ssrf)
  ...
  # 
  def test_send_request_auth_to_uri_curl
    ssrf = SSRFProxy::HTTP.new(url: 'http://127.0.0.1:8088/curl?url=xxURLxx')
    assert valid_ssrf?(ssrf)
